...
const addSponsor = (name, details) => {
  ...
  const div = document.createElement("div");
  div.classList.add("card-header");
  div.classList.add("cardexpert2");
  div.innerText = name;

  const ul = document.createElement("ul");
  ul.classList.add("list-group","cardexpert2");

  const li = document.createElement("li");
  li.classList.add("list-group-item",'cardexpert2');
...
// Function to dynamically create the carousel
